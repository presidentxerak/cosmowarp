...
const KNOWLEDGE_BASE: KnowledgeEntry[] = [
  ...
  // WhitePaper
  {
    ...
    response: {
      answer: "The White Paper is the sacred scroll of CosmoWarp! 10 sections covering everything: the DAG mesh, CosmoCode VM, cryptographic stack, tokenomics (69M supply, Resonance Decay), the 7-level hierarchy, security architecture, and the roadmap. It's like reading the source code of the universe, but with better formatting.",
...
const FAQ_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'Where is my data stored?', a: 'Locally on your device (localStorage). No server stores your keys, wallet, or media. You own everything.' },
    ],
  },
];
        ...
        <div className="glass-panel flex flex-col" style={{ height: '65vh', minHeight: 400 }}>
          ...
          <div className="p-3 border-t border-white/5">
            ...
            <div className="flex gap-2 mt-2 flex-wrap">
              {['How do I mine?', 'What is CWCERT?', 'How does CosmoChat work?', 'Is it secure?'].map(q => (
                <button
                  key={q}
                  onClick={() => { setInput(q); }}
