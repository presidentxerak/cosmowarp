    ...
    <div className="space-y-4">
      ...
      <div className="glass-panel p-5 sm:p-6">
        ...
        <p className="text-base opacity-50">
          Build apps, extensions, and integrations on the Strangrz ecosystem.
  ...
  return (
    <div>
      ...
      <p className="text-base opacity-50 mb-4">
        The Strangrz SDK is a JavaScript/TypeScript library for building applications
        on the Strangrz ecosystem.
      </p>
  ...
  return (
    <div>
      ...
      <ApiMethod
        ...
        desc="Check if an address has valid Strangrz format (CW + 40 hex chars)."
