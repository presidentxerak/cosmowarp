...
const TRANSLATIONS: Record<string, Record<string, string>> = {
  fr: {
    ...
    certify: 'Certifier',
    certifyDesc: 'Chaque oeuvre reçoit un certificat STCERT : empreinte SHA-256, signature Ed25519 du créateur, horodatage. Infalsifiable et vérifiable par tous.',
    ...
    step3Desc: 'Strangrz calcule l\'empreinte SHA-256 du fichier et la signe avec votre clé privée. Le certificat STCERT est créé instantanément.',
    step4: 'Mise en vente',
  ...
  en: {
    ...
    certify: 'Certify',
    certifyDesc: 'Each work receives a STCERT certificate: SHA-256 fingerprint, Ed25519 signature from the creator, timestamp. Tamper-proof and verifiable by all.',
    ...
    step3Desc: 'Strangrz computes the SHA-256 fingerprint of the file and signs it with your private key. The STCERT certificate is created instantly.',
  ...
  ja: {
    ...
    certify: '認証',
    certifyDesc: '各作品はSTCERT証明書を受け取ります：SHA-256フィンガープリント、クリエイターのEd25519署名、タイムスタンプ。改ざん不可能で全員が検証可能。',
    publishTitle: '公開',
    ...
    step3: '自動認証',
    step3Desc: 'StrangrzがファイルのSHA-256フィンガープリントを計算し、秘密鍵で署名します。STCERT証明書が即座に作成されます。',
    step4: '販売開始',
